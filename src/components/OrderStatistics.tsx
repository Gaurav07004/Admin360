    ...
    return (
        <div className="flex flex-col items-center gap-5 w-full">
            <div className="w-full py-4 px-5 bg-white rounded-[1rem]">
                <p className="text-[1.1rem] font-semibold text-gray-600 mb-4">Top Products</p>
                {isLoading || topProductData.length === 0 ? (
                    ...
                    <ul>
                        {topProductData.map((product, index) => (
                            <li key={index} className="p-4 mb-3 w-full bg-gray-100 rounded-lg border border-gray-300">
                                <div className="flex items-center w-full">
                                    ...
                                    <div className="ml-4 flex-1">
                                        <div className="flex justify-between w-full">
                                            ...
                                            <span className="text-sm font-medium text-slate-600">{product.value}</span>
                                        </div>
