...
export const { updateProductStatus, updateProductStock, setDrawerStatus, setSelectedProduct, setProductDrawerStatus, setProduct, setProductMonthlyData } = productSlice.actions;
